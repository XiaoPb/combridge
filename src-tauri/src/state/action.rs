...
impl fmt::Display for Action {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Action::DeviceUpdateConfig { device_id, .. } => write!(f, "DEVICE_UPDATE_CONFIG({})", device_id),
            Action::ChannelAdd { device_id, channel_id, .. } => write!(f, "CHANNEL_ADD({}/{})", device_id, channel_id),
            Action::ChannelSubscribe { device_id, channel_id, .. } => write!(f, "CHANNEL_SUBSCRIBE({}/{})", device_id, channel_id),
            Action::DataSend { device_id, channel_id, .. } => write!(f, "DATA_SEND({}/{})", device_id, channel_id),
            Action::DataReceive { device_id, channel_id, .. } => write!(f, "DATA_RECEIVE({}/{})", device_id, channel_id),
            Action::BufferClear { device_id, channel_id } => write!(f, "BUFFER_CLEAR({}/{})", device_id, channel_id),
